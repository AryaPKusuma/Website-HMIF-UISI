...
@section('content')
    ...
    <section class=" py-16 flex flex-1 items-center bg-center bg-cover bg-black ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-left sm:text-center lg:py-20 lg:px-12 ">
            <h1 class="mb-4 text-2xl font-bold leading-none md:text-6xl lg:text-7xl tracking-widest text-white">
                RISTEK
            </h1>
            <p class="mb-12 text-lg font-light text-gray-200 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-300">
                Riset dan Teknologi
            </p>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 sm:py-12 lg:py-20 px-4 mx-auto max-w-screen-md">
            ...
            <p class="font-normal text-gray-500 dark:text-gray-400 sm:text-xl">
                ...
                mahasiswa untuk mengembangkan minat bakatnya dengan mengadakan berbagai kegiatan kemahasiswaan yang bermanfaat.
            </p>

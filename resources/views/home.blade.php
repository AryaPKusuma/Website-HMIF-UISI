...
@section('content')
    ...
    <section class=" py-16 flex flex-1 items-center bg-center bg-cover bg-gray-950 dark:bg-gradient-to-bl from-blue-900 to-gray-950">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-left sm:text-center lg:py-20 lg:px-12 ">
            <h1 class="mb-4 text-4xl font-bold leading-none sm:text-6xl lg:text-7xl text-white">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="px-4 sm:px-16 py-12 lg:py-16 items-center">
            ...
            <div class=" grid grid-cols md:grid-cols-2 gap-4 py-6">
                <div
                    class="bg-gray-50 text-gray-500 dark:bg-gray-900 p-6 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:border-blue-500 transition-all duration-500 rounded-lg border-solid border border-gray-700 ">
                ...
                <div
                    class="bg-gray-50 text-gray-500 dark:bg-gray-900 p-6 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:border-blue-500 transition-all duration-500 rounded-lg border-solid border border-gray-700">
                    <p class="font-medium sm:text-xl">Menjalin hubungan yang baik dan berkontribusi aktif dalam kegiatan kemasyarakatan

...
@section('content')
    ...
    <section class="relative bg-white dark:bg-gray-900 z-0">

        <div class="absolute grid grid-cols-2 -z-10 w-full m-auto h-max opacity-40">
            <div class="blur-[170px] h-40 bg-primary-400"></div>
            <div></div>
        </div>
        ...
        <div class="px-4 sm:px-16 py-12 lg:py-16 items-center">
            <h1
                ...
                data-aos="fade-right" data-aos-duration="700" data-aos-once="false" data-aos-mirror="false">
                Tujuan
            </h1>
            <p class="font-ligth text-gray-500 md:text-lg sm:text-center lg:text-left mb-2 dark:text-gray-400"
            data-aos="fade-right" data-aos-duration="700"  data-aos-delay="100" data-aos-once="false">
                lorem ipsum dolor shit amet
            </p>

            <div class=" grid grid-cols md:grid-cols-2 gap-4 py-6 ">
                <div
                    class="bg-gray-100 text-gray-500 dark:bg-gray-800 p-6 dark:text-gray-400
                     hover:bg-gray-300 hover:text-gray-900 dark:hover:bg-gray-700 dark:hover:text-gray-200
                      hover:border-blue-500 transition-all rounded-lg"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 sm:px-16 ">
            ...
            <div class="grid gap-4 mb-6 sm:grid-cols-2 lg:grid-cols-3 antialiased">
                ...
                px-8 pb-8 pt-40 w-full mx-auto mt-16"
                ...
                <div class="relative grayscale hover:grayscale-0 transition duration-700 ease-out isolate flex flex-col justify-end overflow-hidden
                 rounded-2xl px-8 pb-8 pt-40 w-full mx-auto mt-16"
                ...
                <div class="relative grayscale hover:grayscale-0 transition duration-700 ease-out isolate flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 w-full mx-auto mt-16"
                data-aos="zoom-in" data-aos-duration="700" data-aos-delay="100">
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form action="{{ route('emails.store') }}" method="POST" class="space-y-8">
                @csrf
                <div>
                    <label for="email"

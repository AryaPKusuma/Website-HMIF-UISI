...
@section('tittle', 'Divisi Riset dan Teknologi')
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 sm:py-10 lg:py-14 px-4 mx-auto max-w-screen-md">
            ...
            <p class="font-normal text-gray-500 dark:text-gray-400 sm:text-xl">
                ...
                mahasiswa untuk mengembangkan minat bakatnya dengan mengadakan berbagai kegiatan kemahasiswaan yang
                bermanfaat.
            </p>
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/RISTEK/gunturanugroho.JPG') }}" alt="Bonnie Avatar">
                ...
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/RISTEK/aryaPutraKusuma.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Arya Putra Kusuma</a>
                    </h3>
                    {{-- <span class="bg-primary-500 text-xs text-white px-3 py-1 rounded-full">Staff</span> --}}
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/RISTEK/erlanggabagasyunanta.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Erlangga Bagas Yunanta</a>
                    </h3>
                    {{-- <span class="bg-primary-500 text-xs text-white px-3 py-1 rounded-full">Staff</span> --}}
                </div>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/RISTEK/hudiyatusakda.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Hudiyatus Akda</a>
                    </h3>
                    {{-- <span class="bg-primary-500 text-xs text-white px-3 py-1 rounded-full">Staff</span> --}}
                </div>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/RISTEK/irenabeltarina.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Iren Abel Tarina</a>
                    </h3>
                    {{-- <span class="bg-primary-500 text-xs text-white px-3 py-1 rounded-full">Staff</span> --}}
                </div>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/RISTEK/yogilistianto.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Yogi Listianto Nurcahyo</a>
                    </h3>
                    {{-- <span class="bg-primary-500 text-xs text-white px-3 py-1 rounded-full">Staff</span> --}}
                </div>

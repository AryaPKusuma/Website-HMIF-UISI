...
@section('tittle', 'Divisi Kewirausahaan')
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 sm:py-12 lg:py-16  px-4 mx-auto max-w-screen-md">
            ...
            <p class="font-normal text-gray-500 dark:text-gray-400 sm:text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat est veniam quae! Tempore, a sequi. Dolorem
                voluptates, illo, at ipsum, doloremque consectetur quidem voluptatibus pariatur ducimus fugiat dignissimos
                modi libero.
            </p>
                ...
                <div class="-my-4 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
                        ...
                        <p class=" text-lg font-normal text-gray-500 dark:text-gray-400">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores placeat cum laudantium
                            a adipisci voluptatum quidem perferendis neque consequatur! Dolorem, autem quod magnam
                            architecto magni accusantium sunt quasi sequi vel?
                        </p>
                    </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/KWU/ahmadzakki.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Ahmad Zakki</a>
                    </h3>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/KWU/evitarahmatuljannah.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Evita Rahmatul Jannah</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/KWU/mnaufalainurrofiq.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">M. Naufal Ainur Rofiq</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/KWU/zidnyalfianbarik.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Zidny Alfian Barik</a>
                    </h3>
                </div>

...
@section('tittle', 'Divisi Hubungan Masyarakat')
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 sm:py-12 lg:py-16  px-4 mx-auto max-w-screen-md">
            ...
            <p class="font-normal text-gray-500 dark:text-gray-400 sm:text-xl">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magni officia repellendus inventore recusandae
                blanditiis? Hic incidunt, quaerat explicabo numquam corporis officia beatae inventore sed. Corrupti harum
                saepe unde nisi neque.
            </p>
                ...
                <div class="-my-4 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
                        ...
                        <p class=" text-lg font-normal text-gray-500 dark:text-gray-400">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, distinctio quia
                            molestiae libero corrupti officiis voluptates doloribus error quam nobis, odio ipsum eum
                            mollitia alias rem odit dolorum repellendus corporis.
                        </p>
                    </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-lg text-center lg:py-16 sm:lg-6 lg:px-16">
            <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Daftar Anggota
                </h2>
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/HUMAS/arsyachmadfahreza.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Arsy Achmad Fahreza</a>
                    </h3>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/HUMAS/ahmadagustinofathoni.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Ahmad Agustio Fathoni</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/HUMAS/helmaesadiegoputra.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Helmaesa Diego Putra</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/HUMAS/lalutedyadiatma.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Lalu Tedy Adiatma</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/HUMAS/mahdaainiyahmadani.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Nahda Ainiyah Madani</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/HUMAS/naufalafdillahikhsan.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Naufal Afdillah Ikhsan</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/HUMAS/putrirahmayanti.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Putri Rahmayanti</a>
                    </h3>
                </div>

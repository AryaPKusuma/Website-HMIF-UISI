...
@section('tittle', 'Divisi Pengembangan Sumberdaya Mahasiswa')
    ...
    <section class=" py-16 flex flex-1 items-center bg-center bg-cover bg-gradient-to-r from-blue-600 to-violet-600">
        <div class=" pt-16 px-4 mx-auto max-w-screen-xl text-left sm:text-center lg:pb-14 lg:pt-32 lg:px-12 ">
            ...
            <p class="mb-4 text-lg font-light text-gray-200 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-300">
                Pengembangan Sumberdaya Mahasiswa
            </p>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 sm:py-12 lg:py-16  px-4 mx-auto max-w-screen-md">
            ...
            <p class="font-normal text-gray-500 dark:text-gray-400 sm:text-xl">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Autem magnam est illo quaerat eveniet dolor
                repudiandae, adipisci voluptas aspernatur amet quidem, numquam quis asperiores nam exercitationem quos
                architecto vitae? Accusantium.
            </p>
                ...
                <div class="-my-4 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
                        ...
                        <p class=" text-lg font-normal text-gray-500 dark:text-gray-400">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem saepe magnam labore fuga,
                            temporibus nostrum neque vero fugit nemo at culpa accusamus, quae mollitia officia ex
                            possimus doloremque tempora sequi!
                        </p>
                    </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/PSDM/helmisebastian.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Helmi Sebastian</a>
                    </h3>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/PSDM/davidfristian.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">David Fristian</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/PSDM/fatimjamil.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Fatim Jamil</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/PSDM/joysetiawan.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Joy Setiawan</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/PSDM/nurameliaramadhani.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Nur Amelia Ramadhani</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/PSDM/raflisetiawan.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Rafli Setiawan</a>
                    </h3>
                </div>

                <div class="text-center text-gray-500 dark:text-gray-400 mb-2">
                    <img class="mx-auto mb-4 w-48 h-w-48 rounded-md transition duration-700 ease-in-out grayscale hover:grayscale-0"
                        src="{{ asset('img/2023/PSDM/riyojessenniako.JPG') }}" alt="Bonnie Avatar">
                    <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Riyo Jessenniako</a>
                    </h3>
                </div>
